...
const ProductSkateboard = async ({id}: Props) => {
    ...
    const dominantColors = isFilled.image(product.data.image) ? await getDominantColor(product.data.image.url) : undefined
    return (
        <div className='group relative mx-auto w-full max-w-72 px-8 pt-4'>
            ...
            <div className='~mb-1 overflow-hidden py-4'>
             ...
             <PrismicNextImage alt="" field={product.data.image} width={150} className='mx-auto w-[60%] origin-topn transform-gpu transition-transform duration-500 ease-in-out group-hover:scale-150'/>
            </div>
            <HorizontalLine className={HORIZONTAL_LINE_CLASSES}/>
...
export default ProductSkateboard
