...
import { SkaterScribble } from "@/app/components/SkaterScribble";
...
export const Skater = ({ skater, index }: Props) => {
  const colors =[
    "text-brand-blue",
    "text-brand-lime",
    "text-brand-orange",
  ...
  return (
    <div className="skater group relative flex flex-col items-center gap-4">
      <div className="stack-layout overflow-hidden">
        ...
        />
        <SkaterScribble className={clsx("relative",scribbleColors)}/>
        <PrismicNextImage
        ...
        />
        <div className="realtive h-48 w-full place-self-end bg-gradient-to-t from-black via-orange to-transparent z-1000">
